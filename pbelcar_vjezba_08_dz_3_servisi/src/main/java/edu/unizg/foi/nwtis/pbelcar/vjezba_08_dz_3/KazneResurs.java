...
public class KazneResurs {
  ...
  public Response getJsonKaznaVozilo(@HeaderParam("Accept") String tipOdgovora,
    ...
    return Response.status(Response.Status.OK).entity(this.pretvoriKolekcijuKazna(kazne, id)).build();
  }
  ...
  private void ucitajKonfiguraciju() {
    try {
      ...
      this.adresa = konfig.dajPostavku("app.kazne.adresa");
      this.vrata = Integer.valueOf(konfig.dajPostavku("app.kazne.mreznaVrata"));
