...
public class SimulacijeFacade {
  ...
  public List<Pracenevoznje> vratiVoznjePoId(int id, long vrijemeOd, long vrijemeDo, VozilaFacade vF) {
    /*
     * "SELECT ID, BROJ, VRIJEME, BRZINA, SNAGA, STRUJA, VISINA, GPSSIRINA, GPSDUZINA, TEMPVOZILA, POSTOTAKBATERIJA,"
     * + " NAPONBATERIJA, KAPACITETBATERIJA, TEMPBATERIJA, PREOSTALOKM, UKUPNOKM, GPSBRZINA " +
  ...
  public String vratiDodavanjeVoznje(String adresa, int vrata, Vozilo v,
      VozilaFacade vF) {
    /*
  ...
  private Pracenevoznje konvertiraj(Vozilo vozilo, VozilaFacade vF) {
