...
public class VoznjeResurs {
  ...
  @Produces({MediaType.APPLICATION_JSON})
  public Response postJsonDodajVoznj(@HeaderParam("Accept") String tipOdgovora,
      PodaciVozila novaVoznja) {
  ...
  private void ucitajKonfiguraciju() {
    ...
    this.adresa = this.konfig.get("app.vozila.adresa").asString().orElse("Addresa placeholder");
    this.vrata = this.konfig.get("app.vozila.mreznaVrata").asInt().orElse(0);
