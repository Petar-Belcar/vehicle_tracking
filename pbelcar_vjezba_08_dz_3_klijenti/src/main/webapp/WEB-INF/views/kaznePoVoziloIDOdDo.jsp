...
<title>REST MVC - Pregled kazne po IDu vozila u vremenskom rasponu</title>
<style type="text/css">
table, th, td {
	border: 1px solid;
}
...
<body>
	<h1>REST MVC - Pregled kazne po IDu vozila u vremenskom rasponu</h1>
	<ul>
		<li><a
	...
	<br />
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/kazne/ispisKazneVoziloIDOdDo">
		<table>
			<tr>
				<td>ID vozila:</td>
				<td><input name="id" />
